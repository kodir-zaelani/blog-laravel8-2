<div>
    @section("title")Category Post @endsection
    <div class="cta-header pt-5">
        <div class="container-fluid">
            <div class="row justify-content-center pt-5">
                <div class="col-lg-6 col-md-6 col-12">
                    <div class="cta-header-title text-center">
                        @if ($categorypost->ImageThumbUrl)
                            <img src="{{ $categorypost->imageThumbUrl }}" 
                        ...
                        @endif
                        <h2 class="py-4 text-uppercase font-weight-bold">{{ $categorypost->title }}</h2>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="section-detail" style="background-color:#edf2f7">
        <div class="container-fluid">
            <div class="row">
                <div class="col-12">
                  <h3 class="font-weight-bold mb-3 text-uppercase">ARTIKEL DENGAN KATEGORI "{{ $categorypost->title }}"</h3><hr>
                </div>
            </div>
            <div class="row">
