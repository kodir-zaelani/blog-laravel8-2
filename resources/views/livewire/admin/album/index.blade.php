        ...
        <div class="col-md-12">
            <div class="card card-primary">
                <div class="card-header">
                    <a href="{{ route('admin.albums.create') }}" class="btn btn-sm btn-success">Add New</a>
                ...
                <div class="card-body ">
                    ...
                    <div class="row">
                        <div class="col-lg-12 col-md-12 col-12">
                            <div class="table-responsive">
                                ...
                                <tbody>
                                    @if (count($albums)) 
                                    @foreach ($albums as $no => $item)
                                    <tr>
                                        <th class="text-right" scope="row">{{ $no + $albums->firstItem() }}</th>
                                        <td>{{ $item->title }}</td>
                                        ...
                                        <td class="text-center">
                                            <a title="Edit" class="btn btn-sm btn-warning edit-row" href="{{route('admin.albums.edit', $item->slug)}}">
                    ...
                    <div class="mt-3 row">
                        ...
                        <div class="text-right col">
                            Page : {{ $albums->currentPage() }} | Show {{ $albums->count() }} data of {{ $albums->total() }}
                        </div>
                    </div>
                    {{-- Modal Add New--}}
