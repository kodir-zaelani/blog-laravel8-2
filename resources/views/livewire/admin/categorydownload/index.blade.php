        ...
        <div class="col-md-12">
            <div class="card card-primary">
                <div class="card-header">
                    ...
                    <a href="{{ route('admin.categorydownloads.create') }}" class="btn btn-sm btn-success">Add New</a>
                ...
                <div class="card-body ">
                    ...
                    <div class="row">
                        <div class="col-lg-12 col-md-12 col-12">
                            <div class="table-responsive">
                                ...
                                <tbody>
                                    @if (count($categorydownloads)) 
                                    @foreach ($categorydownloads as $no => $item)
                                    <tr>
                                        <th class="text-right" scope="row">{{ $no + $categorydownloads->firstItem() }}</th>
                                        <td>{{ $item->title }}</td>
                                        <td>{{ $item->slug }}</td>
                                        ...
                                        <td class="text-center">
                                            <a title="Edit" class="btn btn-sm btn-warning edit-row" href="{{route('admin.categorydownloads.edit', $item->slug)}}">
                    ...
                    <div class="mt-3 row">
                        <div class="col">
                            {{ $categorydownloads->links() }}
                        </div>
                        <div class="text-right col">
                            Page : {{ $categorydownloads->currentPage() }} | Show {{ $categorydownloads->count() }} data of {{ $categorydownloads->total() }}
                        </div>
                    </div>
                    {{-- Modal Add New--}}
