        ...
        <div class="col-md-12">
            <div class="card card-primary">
                <div class="card-header">
                    <a href="{{ route('admin.widgets.create') }}" class="btn btn-sm btn-success">Add New</a>
                    ...
                    <div class="row">
                            ...
                            <div class="table-responsive">
                                <table id="dataTable" class="table table-bordered table-hover" style="width=100%">
                                    <thead class="text-center">
                                        ...
                                        <tbody>
                                            @if (count($widgets)) 
                                            @foreach ($widgets as $no => $item)
                                            <tr>
                                                <th class="text-right" scope="row">{{ $no + $widgets->firstItem() }}</th>
                                                <td>{{ $item->title }}</td>
                                                <td>{{ $item->author->name }}</td>
                                                <td>{{ $item->position }}</td>
                                                <td>{!! $item->status_label !!}</td>
                                                <td class="text-center">
                                                    <a title="Edit" class="btn btn-sm btn-warning edit-row" href="{{route('admin.widgets.edit', $item->slug)}}">
                        ...
                        <div class="mt-3 row">
                            ...
                            <div class="text-right col">
                                Page : {{ $widgets->currentPage() }} | Show {{ $widgets->count() }} data of {{ $widgets->total() }}
                            </div>
                        </div>
                        {{-- Modal Add New--}}
