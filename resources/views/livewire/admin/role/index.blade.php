                    ...
                    <div class="row">
                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <th class="text-right" scope="row">{{ $no + $roles->firstItem() }}</th>
                                            <td>{{ $item->name }}</td>
                                            <td class="text-center">
                                                @can('roles.edit')
                                                <a href="{{ route('admin.roles.edit', $item->id) }}" class="mt-2 btn btn-sm btn-primary">
                                                    <i class="fa fa-pencil-alt"></i>
                                                </a>
                                                @endcan
                                                
                                                @can('roles.delete')
                                                <button wire:click="selectItem({{ $item->id }}, 'delete')"  class="mt-2 btn btn-sm btn-danger" title="Delete"><i class="fas fa-trash-alt"></i></button>
                                                @endcan
                                            </td>
                                        </tr>
                                        @endforeach
                        ...
                        <div class="mt-3 row">
                            ...
                            <div class="text-right col">
                                Page : {{ $roles->currentPage() }} | Showing {{ $roles->count() }}  of {{ $roles->total() }} entries
                            </div>
                        </div>
                        {{-- Modal Add New--}}
                            ...
                            <div class="modal-dialog modal-lg">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h5 class="modal-title" id="modalFormLabel">New Role</h5>
                        ...
                        <div class="modal fade" id="modalEditForm" tabindex="-1" aria-labelledby="modalEditFormLabel" aria-hidden="true">
                            <div class="modal-dialog modal-lg">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h5 class="modal-title" id="modalEditFormLabel">Edit Role</h5>
                                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                            <span aria-hidden="true">&times;</span>
                                        </button>
                                    </div>
