        ...
        <div class="col-md-12">
            <div class="card card-primary">
                <div class="card-header">
                    ...
                    <a href="{{ route('admin.setarticles.create') }}" class="btn btn-sm btn-success">Add New</a>
                    ...
                    <div class="row">
                        <div class="col-lg-12 col-md-12 col-12">
                            <div class="table-responsive">
                                ...
                                <tbody>
                                    @foreach ($setarticles as $no => $item)
                                    <tr>
                                        <th class="text-right" scope="row">{{ $no + $setarticles->firstItem() }}</th>
                                        <td>{{ $item->title }}</td>
                                        <td>{{ $item->slug }}</td>
                                        <td> @if (!empty($item->image))
                                            ...
                                            <td class="text-center">
                                                <a title="Edit" class="btn btn-sm btn-warning edit-row" href="{{route('admin.setarticles.edit', $item->slug)}}">
                        ...
                        <div class="mt-3 row">
                            ...
                            <div class="text-right col">
                                Page : {{ $setarticles->currentPage() }} | Show {{ $setarticles->count() }} data of {{ $setarticles->total() }}
                            </div>
                        </div>
                        @else
