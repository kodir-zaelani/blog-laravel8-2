        ...
        <div class="col-md-12">
            <div class="card card-primary">
                <div class="card-header">
                    ...
                    <a href="{{ route('admin.photos.create') }}" class="btn btn-sm btn-success">Add New</a>
                ...
                <div class="card-body ">
                    ...
                    <div class="row">
                        <div class="col-lg-12 col-md-12 col-12">
                            <div class="table-responsive">
                                ...
                                <tbody>
                                    @if (count($photos)) 
                                    @foreach ($photos as $no => $item)
                                    <tr>
                                        <th class="text-right" scope="row">{{ $no + $photos->firstItem() }}</th>
                                        <td>{{ $item->title }}</td>
                                        ...
                                        <td class="text-center">
                                            <a title="Edit" class="btn btn-sm btn-warning edit-row" href="{{route('admin.photos.edit', $item->slug)}}">
                    ...
                    <div class="mt-3 row">
                        ...
                        <div class="text-right col">
                            Page : {{ $photos->currentPage() }} | Show {{ $photos->count() }} data of {{ $photos->total() }}
                        </div>
                    </div>
                    {{-- Modal Add New--}}
