...
@section('title', 'Edit a Photo') 
@section('subtitle', ' Photo') 
@section('content')
        ...
        <div class="mb-2 row">
            ...
            <div class="col-sm-6 ">
                ...
                <ol class="breadcrumb float-sm-right">
                    ...
                    <li class="breadcrumb-item"><a href="{{ route('admin.photos.index') }}">@yield('subtitle')</a>
                    </li>
...
<section class="content">
    <div class="container-fluid">
        <form id="post-form" enctype="multipart/form-data" action="{{ route('admin.photos.update', $photo) }}"  method="POST">
            @csrf
            @method('PUT')
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="card card-primary">
                        <div class="card-header">
                            <h3 class="card-title">Edit a Photo</h3>
                        </div>
                        ...
                        <div class="card-body">
                            ...
                            <div class="card-body">
                                        ...
                                        <div class="text-center form-group">
                                            ...
                                            <div class="fileinput fileinput-new " data-provides="fileinput">
                                                <div class="fileinput-new img-thumbnail" style="width: 200px;">
                                                        <img src="{{ ($photo->imageThumbUrl) ? $photo->imageThumbUrl : '/assets/admin/dist/img/no_image.png' }}"  alt="...">
                                                </div>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12 col-md-12 col-12">
                                            <div class="form-group">
                                                ...
                                                <input id="title" name="title" type="text" class="form-control @error('title') is-invalid @enderror" placeholder="Title" value="{{ old('title') ?? $photo->title }}">
                                                @error('title')
                                            ...
                                            <div class="form-group ">
                                                <label for="album_id">Album <font style="color: red">*</font></label>
                                                <select class="form-control select2bs4 @error('album_id') is-invalid @enderror" name="album_id" id="album_id">
                                                    <option value="" holder>Select Album</option>
                                                    @foreach ($albums as $item)
                                                    <option value="{{ $item->id }}"
                                                        @if($item->id == $photo->album_id)
                                                        selected
                                                        @endif
                                                        >{{  $item->title }}</option>
                                                    @endforeach
                                            ...
                                            <div class="form-group">
                                                <label for="caption">Caption <font style="color: red">*</font></label>
                                                <textarea name="caption" id="caption" class="form-control my-editor @error('caption') is-invalid @enderror" placeholder="Content" rows="10">{{ old('caption') ?? $photo->caption}}</textarea>
                                                @error('caption')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
                                ...
                                <div class="card-footer">
                                    ...
                                    <a href="{{ route('admin.photos.index') }}" class="float-right btn btn-info" >Back</a>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    {{-- <script src="{{ url('') }}/vendor/laravel-filemanager/js/script.js"></script>    --}}
        <script>
            $(function () {
