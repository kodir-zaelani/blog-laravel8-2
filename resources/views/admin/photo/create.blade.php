...
<section class="content">
    <div class="container-fluid">
        <form id="post-form" enctype="multipart/form-data" action="{{ route('admin.photos.store') }}"  method="POST">
            @csrf
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="card card-primary">
                        <div class="card-header">
                            <h3 class="card-title">Create a Photo</h3>
                        </div>
                        ...
                        <div class="card-body">
                            ...
                            <div class="card-body">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12 col-md-12 col-12">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <textarea name="caption" id="caption" class="form-control my-editor @error('caption') is-invalid @enderror" placeholder="Content" rows="10">{{ old('caption') }}</textarea>
                                                @error('caption')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
                                ...
                                <div class="card-footer">
                                    ...
                                    <a href="{{ route('admin.photos.index') }}" class="btn btn-info float-right" >Back</a>
                                </div>
                            </div>
                        </div>
                    </div>
