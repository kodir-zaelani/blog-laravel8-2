...
@section('subtitle', 'List Advertisement') 
@section('content')
        ...
        <div class="mb-2 row">
            ...
            <div class="col-sm-6 ">
                ...
                <ol class="breadcrumb float-sm-right">
                    ...
                    <li class="breadcrumb-item"><a href="{{ route('admin.advertisements.index') }}">@yield('title')</a>
                        </li>
...
<section class="content">
    <div class="container-fluid">
        @livewire('admin.advertisement.index')
    </div>
</section>         
{{-- @endsection --}}
