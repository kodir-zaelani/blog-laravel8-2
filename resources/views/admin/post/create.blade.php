...
@section('title', 'Post') 
@section('subtitle', 'Create a Post') 
@section('content')
...
<section class="content">
    <div class="container-fluid">
        <form id="post-form" enctype="multipart/form-data"  action="{{ route('admin.posts.store') }}" method="POST">
         @csrf
            <div class="row">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group ">
                                ...
                                <div class="input-group">
                                    ...
                                    @enderror
                                    <a href="{{ route('admin.setarticles.create') }}" class="btn btn-outline-secondary">Add New</a>
                            ...
                            <div class="form-group">
                                <label for="headline">
                                    ...
                                    <div class="mr-2 form-check d-inline">
                                        <input value= 1 class="form-check-input" type="radio" id="headline1" name="headline" checked>
                                        <label for="headline" class="form-check-label">Active</label>
                                    </div>
                                    <div class="form-check d-inline">
                                        <input value= 0 class="form-check-input" type="radio" id="headline2" name="headline" >
                            ...
                            <div class="form-group">
                                <label for="selection">
                                    ...
                                    <div class="mr-2 form-check d-inline">
                                        <input value= 1 class="form-check-input" type="radio" id="selection1" name="selection"  checked>
                                        <label for="selection" class="form-check-label">Primary</label>
                                    </div>
                                    <div class="form-check d-inline">
                                        <input value= 0 class="form-check-input" type="radio" id="selection2" name="selection" >
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="content" id="content" class="form-control my-editor @error('content') is-invalid @enderror" placeholder="Content" rows="20">{{ old('content') }}</textarea>
                                @error('content')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
    ...
    <!-- TinyMCE -->
    {{-- <script src="{{ asset('assets/admin/plugins/tinymce/jquery.tinymce.min.js') }}"></script>
    ...
    <script src="https://cdnjs.cloudflare.com/ajax/libs/tinymce/4.9.0/plugins/link/plugin.min.js"></script>
    {{-- <script src="{{ asset('assets/admin/plugins/tiny_mce_wiris/js/select2.full.min.js') }}"></script> --}}
