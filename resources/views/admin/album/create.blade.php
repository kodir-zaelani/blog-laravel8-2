...
<section class="content">
    <div class="container-fluid">
        <form id="post-form" enctype="multipart/form-data" action="{{ route('admin.albums.store') }}"  method="POST">
            @csrf
            <div class="row">
                <div class="col-md-12">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12 col-md-12 col-12">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <textarea name="description" id="description" class="form-control my-editor @error('description') is-invalid @enderror" placeholder="Content" rows="10">{{ old('description') }}</textarea>
                                                @error('description')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
