        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card card-primary">
                    ...
                    <form enctype="multipart/form-data" action="{{ route('admin.categorydownloads.update', $categorydownload->slug) }}" method="POST">
                    @csrf
                    @method('put')
                    ...
                    <div class="card-body">
                        <div class="form-group">
                            ...
                            <input type="text" name="title" value="{{ old('title')?? $categorydownload->title }}" class="form-control @error('title') is-invalid @enderror" placeholder="Enter a category title">
                            @error('title')
                        ...
                        <div class="text-center form-group">
                            ...
                            <div class="text-center fileinput fileinput-new" data-provides="fileinput">
                                <div class="fileinput-new img-thumbnail" style="max-width: 190px;">
                                    ...
                                    <img src="{{ ($categorydownload->imageThumbUrl) ? $categorydownload->imageThumbUrl : '/assets/admin/dist/img/no_image.png' }}"  alt="...">
                                </div>
