        ...
        <div class="mb-2 row">
            ...
            <div class="col-sm-6 ">
                ...
                <ol class="breadcrumb float-sm-right">
                    ...
                    <li class="breadcrumb-item"><a href="{{ route('admin.subcategoryposts.index') }}">@yield('title')</a>
                        </li>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card card-primary">
                    ...
                    <form enctype="multipart/form-data" action="{{ route('admin.subcategoryposts.update', $subcategorypost->slug) }}" method="POST">
                    @csrf
                    @method('put')
                    ...
                    <div class="card-body">
                        <div class="form-group">
                            ...
                            <input type="text" name="title" value="{{ old('title')?? $subcategorypost->title }}" class="form-control @error('title') is-invalid @enderror" placeholder="Enter a category title">
                            @error('title')
                            ...
                            <select class="form-control select2bs4 @error('categorypost_id') is-invalid @enderror" name="categorypost_id" id="categorypost_id">
                                <option value="" holder>Select Category <option>
                                    ...
                                    <option value="{{ $item->id }}"
                                        @if($item->id == $subcategorypost->categorypost_id)
                                        selected
                                        @endif
                                        >{{  $item->title }}</option>
                                    @endforeach
                        ...
                        <div class="text-center form-group">
                            ...
                            <div class="text-center fileinput fileinput-new" data-provides="fileinput">
                                <div class="fileinput-new img-thumbnail" style="max-width: 190px;">
                                    ...
                                    <img src="{{ ($subcategorypost->imageThumbUrl) ? $subcategorypost->imageThumbUrl : '/assets/admin/dist/img/no_image.png' }}"  alt="...">
                                </div>
                    ...
                    <div class="card-footer">
                        ...
                        <a href="{{ route('admin.subcategoryposts.index') }}" class="btn btn-info" >Back</a>
                    </div>
                    </form>
                </div>
            </div>
